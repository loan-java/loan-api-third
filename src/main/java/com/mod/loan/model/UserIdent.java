...
public class UserIdent {
    ...
    /**
     * 获取是否运营商手机认证0未认证，1认证中,2认证成功 ,3认证失败,4已失效
     *
     * @return mobile - 是否运营商手机认证0未认证，1认证中,2认证成功 ,3认证失败,4已失效
     */
    ...
    /**
     * 设置是否运营商手机认证0未认证，1认证中,2认证成功 ,3认证失败,4已失效
     *
     * @param mobile 是否运营商手机认证0未认证，1认证中,2认证成功 ,3认证失败,4已失效
     */
