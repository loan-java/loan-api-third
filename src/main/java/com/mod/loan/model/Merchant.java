...
public class Merchant {
    ...
    public String toString() {
        return "Merchant{" +
                ...
                ", merchantAppIos='" + merchantAppIos + '\'' +
                ", merchantZfb='" + merchantZfb + '\'' +
                ", merchantStatus=" + merchantStatus +
                ", merchantChannel='" + merchantChannel + '\'' +
                ", createTime=" + createTime +
                ", hlb_id='" + hlb_id + '\'' +
                ", hlb_rsa_private_key='" + hlb_rsa_private_key + '\'' +
                ", hlb_rsa_public_key='" + hlb_rsa_public_key + '\'' +
                ", hlb_md5_key='" + hlb_md5_key + '\'' +
                ", hlb_des_key='" + hlb_des_key + '\'' +
                ", merchantMarket='" + merchantMarket + '\'' +
                ", fuyou_merid='" + fuyou_merid + '\'' +
                ", fuyou_secureid='" + fuyou_secureid + '\'' +
                ", fuyou_h5key='" + fuyou_h5key + '\'' +
                ", huiju_id='" + huiju_id + '\'' +
                ", huiju_md5_key='" + huiju_md5_key + '\'' +
                ", bindType=" + bindType +
                '}';
    }
}